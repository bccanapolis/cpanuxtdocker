  ...
  <div>
    <card>
      <template v-slot:content>
        ...
        <h2 class="text-center">Relatórios de Autoavaliação 2019</h2>
        <p class="text-justify px-5">O Relatório de Autoavaliação Institucional do IFG visa fomentar a cultura de
